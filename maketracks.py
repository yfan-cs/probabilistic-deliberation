"""
File: maketracks.py -- Dana Nau <nau@cs.umd.edu>, Feb 14, 2018

Code to make racetrack problems for Project 1. The main program creates racetracks
and prints them to standard output, so if you want to put them in a file you should
either cut-and-paste from the command-line window or redirect standard output.

Sometimes the finish line will partially overlap some of the walls, but there's a
high probability that the problem will still be solvable.
"""
